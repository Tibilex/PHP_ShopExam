      ...
      <div class="admin__panel--main">
         <div class="admin-account__container">
            <form enctype="multipart/form-data" class="add-admin__form" method="post">
               ...
               <input name="prodTitle" type="text">
            ...
            if (isset($_POST['addBtn'])){
               ...
               $pCategory = $_POST['prodCategory'];
               $pImage = $_FILES['file']['name'];
               $products->AddProductInDB($pName, $pPrice, $pCode, $pImage, $pCategory);
            }
            ...
            if (isset($_POST['productEditBtn'])){
               ...
               $pCategory = $_POST['itemCategory'];
               $products->EditProduct($pName, $pPrice, $pCode, $pImage, $pCategory);
            }
            ?>
         </div>
         <div class="admin-product__container tile__two-string">
